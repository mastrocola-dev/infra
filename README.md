...
- Domain validation uses a TXT token, created in the same apply. Validation completes asynchronously on Azure's side within minutes; traffic only moves once the apex CNAME resolves to the validated app.
